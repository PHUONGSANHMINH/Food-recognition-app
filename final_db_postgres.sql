DROP TABLE IF EXISTS "advertising_banners" CASCADE;
...
DROP TABLE IF EXISTS "csv_export_version" CASCADE;
...
DROP TABLE IF EXISTS "recipe_info" CASCADE;
...
DROP TABLE IF EXISTS "recipe_vitamin" CASCADE;
CREATE TABLE "recipe_vitamin" (
  "id_vitamin" SERIAL NOT NULL,
...
DROP TABLE IF EXISTS "recipes_contribution" CASCADE;
...
CREATE INDEX "rating_id_user_idx" ON "rating" ("id_user");
CREATE INDEX "recipe_ingredients_id_recipe_idx" ON "recipe_ingredients" ("id_recipe");
CREATE INDEX "recipe_nutrition_id_recipe_idx" ON "recipe_nutrition" ("id_recipe");
CREATE INDEX "recipe_steps_id_recipe_idx" ON "recipe_steps" ("id_recipe");
CREATE INDEX "recipe_vitamin_id_nutrition_idx" ON "recipe_vitamin" ("id_nutrition");
...
-- Foreign Keys
ALTER TABLE "csv_export_version" ADD CONSTRAINT "csv_export_version_ibfk_1" FOREIGN KEY ("exported_by") REFERENCES "user" ("id_user") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "rating" ADD CONSTRAINT "rating_ibfk_1" FOREIGN KEY ("id_recipe") REFERENCES "recipe_info" ("id_recipe") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "rating" ADD CONSTRAINT "rating_ibfk_2" FOREIGN KEY ("id_user") REFERENCES "user" ("id_user") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipe_ingredients" ADD CONSTRAINT "recipe_ingredients_ibfk_1" FOREIGN KEY ("id_recipe") REFERENCES "recipe_info" ("id_recipe") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipe_nutrition" ADD CONSTRAINT "recipe_nutrition_ibfk_1" FOREIGN KEY ("id_recipe") REFERENCES "recipe_info" ("id_recipe") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipe_steps" ADD CONSTRAINT "recipe_steps_ibfk_1" FOREIGN KEY ("id_recipe") REFERENCES "recipe_info" ("id_recipe") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipe_vitamin" ADD CONSTRAINT "recipe_vitamin_ibfk_1" FOREIGN KEY ("id_nutrition") REFERENCES "recipe_nutrition" ("id_nutrition") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipes_contribution" ADD CONSTRAINT "recipes_contribution_ibfk_1" FOREIGN KEY ("id_recipe") REFERENCES "recipe_info" ("id_recipe") ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE "recipes_contribution" ADD CONSTRAINT "recipes_contribution_ibfk_2" FOREIGN KEY ("id_user") REFERENCES "user" ("id_user") ON DELETE RESTRICT ON UPDATE RESTRICT;
